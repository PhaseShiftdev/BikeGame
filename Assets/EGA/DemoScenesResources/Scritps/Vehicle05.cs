...
public class Vehicle05 : MonoBehaviour {
	...
	void Update () {
		...
		if (manager.inCar05) {
			...
			carCam05.gameObject.SetActive (true);
		} else {
			carCam05.gameObject.SetActive (false);
