...
public class Vehicle12 : MonoBehaviour {
	...
	void Update () {
		...
		if (manager.inCar12) {
			...
			carCam12.gameObject.SetActive (true);
		} else {
			carCam12.gameObject.SetActive (false);
