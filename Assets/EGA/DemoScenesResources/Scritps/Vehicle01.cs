...
public class Vehicle01 : MonoBehaviour {
	...
	void Update () {
		...
		if (manager.inCar01) {
			...
			carCam01.gameObject.SetActive (true);
		} else {
			carCam01.gameObject.SetActive (false);
