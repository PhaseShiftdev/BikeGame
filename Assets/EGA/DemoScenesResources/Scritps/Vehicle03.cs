...
public class Vehicle03 : MonoBehaviour {
	...
	void Update () {
		...
		if (manager.inCar03) {
			...
			carCam03.gameObject.SetActive (true);
		} else {
			carCam03.gameObject.SetActive (false);
